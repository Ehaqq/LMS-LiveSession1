      ...
      <table className="w-full text-left border-collapse">
        ...
        <tbody>
          {transactionData.map((data, index) => (
            ...
            >
              <td className="px-4 py-6 font-medium">{data.date}</td>
              <td className="px-4 py-6 font-medium">{data.customer}</td>
              <td className="px-4 py-6 font-medium">{data.contact}</td>
